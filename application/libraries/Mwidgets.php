...
<?php 
    ...
    public function drawMainSectionHomepageTitle($title, $image , $url = "")
    {
        ...
        $result = '';
        $result = '<div class="main-section-homepage-title-wrapper background-color meme">
    ...
    public function drawSubSectionBox($title, $image , $url="")
    {
        ...
        $result = '
            <div class="section-title-wrapper">
                <div class="row">
                    <div class="col-xs-12">
                        <h2 class="text-color"><a '.$hrefLink.' rel="external">' . $title . '</a></h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12">
                    <div class="section-image-wrapper">
                        <a rel="external" '.$hrefLink.' ><img src="' . $image . '" alt="' . $title . '" class="img-responsive" /></a>
                    </div><!-- end of section-image-wrapper -->
                </div>
            </div><!-- row -->
            ';
	    ...
	    public function drawSubSectionBoxRecipesBestCook($title, $image , $topic_url)
    {
        ...
        $result = '
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="section-image-wrapper">
                        <a href="'.$topic_url.'" rel="external"><img style="width:100%; height: auto" class"best-cook-home-swiper-image" src="' . $image . '" alt="' . $title . '" class="img-responsive" /></a>
                    </div><!-- end of section-image-wrapper -->
                </div>
            </div><!-- row -->
            ';
...
<?php
	        ...
	        $short_title = mb_substr(strip_tags($title), 0, 50 , "utf-8"). (strlen(strip_tags($title)) >35?'...':'');
			echo '';
          ?>
<style>
.fancybox-inner
