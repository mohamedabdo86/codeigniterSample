...
class Upload extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->setPath_img_upload_folder("uploading/");
        $this->setPath_img_thumb_upload_folder("uploading/thumbs/");

        //Delete img url
        $this->setDelete_img_url(base_url() . 'upload/deleteImage/');

        //Set url img with Base_url()
        $this->setPath_url_img_upload_folder(base_url() . "uploading/");
        $this->setPath_url_img_thumb_upload_folder(base_url() . "uploading/thumbs/");
    }
