...
class Images_uploader extends MY_Controller {
	...
	{
		$this->load->view('images_uploader/upload');    
	}
	...
	public function do_upload()
	{
		...
		############ Configuration ##############
		$thumb_square_size 		= 300; //Thumbnails will be cropped to 200x200 pixels
		$max_image_size 		= 500; //Maximum image size (height and width)
		$thumb_prefix			= "thumb_"; //Normal thumb Prefix
		$destination_folder		= base_url().'upload/'; //upload directory ends with / (slash)
