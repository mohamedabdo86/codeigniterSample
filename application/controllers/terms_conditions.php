...
class Terms_conditions extends CI_Controller {
	 ...
	 public function __construct()
   {
		...
		$this->headers->set_second_title(lang("globals_secmenu_terms"));
		
	}
	public function index()
	{
		 $this->data['terms_conditions_desc'] = $this->staticmodel->get_terms_conditions_desc();
		 $this->data['target_page'] =  "static_pages/view_conditions" ;
