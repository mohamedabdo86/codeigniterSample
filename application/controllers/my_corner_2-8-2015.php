   ...
   public function __construct()
   {
	...
	public function create_my_corner($key = "")  
	{
		...
		if($this->input->post('register') == true)
		{
			...
			$this->form_validation->set_rules("username", lang('mycorner_name'), "trim|required|advanced_username|min_length[8]|max_length[20]");
			...
			$this->form_validation->set_rules("members_password", lang('mycorner_password'), "required|advanced_password");
