...
//print_r($display_data);
 ...
 $link=site_url($this->router->class.'/applications/9'); 
 }else{
...
//Display SWF 
$app_link =  base_url()."uploads/applications_src/".$display_data[0]['applications_src'.$current_language_db_prefix];
...
?>
	...
	<div class="global_sperator_height" style="width:100%"></div>
    <?php $this->load->view($display_data[0]['applications_src']); ?>
    <div class="global_sperator_height" style="width:100%"></div>
    </div>
