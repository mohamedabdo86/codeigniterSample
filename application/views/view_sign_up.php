...
<div class="global_background">
    ...
    <table width="60%" border="0" class="float_left">
		<tr>
        	...
        	<td width="65%">
			<?php 
			$data=array( 'name' => 'firstname' , 'size' => 50);                  
        ...
        <tr>        
            <td><h5>Last name</h5></td>
       		<td>
         	<?php 
			$data=array( 'name' => 'lastname' , 'size' => 50); 			 
			echo form_input($data);	 
			?>
            </td>
        </tr>
        <tr>
         ...
         <tr>
              ...
              <td>
              <?php 
		 	  $data=array( 'name' => 'password' ,'value' => "" , 'size' => 50); 
         ...
         <tr>
              ...
              <td>
              <?php 
		 	  $data=array( 'name' => 'repeat_password' ,'value' => "" , 'size' => 50); 
			  echo form_password($data);
			  ?>
            </td>
         </tr>
