...
<div class="image" style="height:181px; "><a href="<?php echo $url;?>" title="<?php echo $title?>"><img alt="<?php echo $title?>" src="<?php echo $image; ?>" /></a></div>
<div class="title float_left dark_gray" style="position: absolute;
top: inherit; bottom:0px;">
    <div style="margin:0 5px;"><a class="dir" href="<?php echo $url ?>"><?php echo $short_title;?></a></div>
