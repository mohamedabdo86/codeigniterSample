...
$language_init = $current_language == 'arabic' ? ' ' : 'en';
...
.feat_lists_tansh2t_teflak ul.ui-tabs-nav-en
{ 
	position: absolute;
	left: 0px;
	top: 7px;
...
.feat_lists_tansh2t_teflak .border_fix_for_tab-en
{
	border-width: 2px;
	border-style: solid;
	position: absolute;
...
.feat_lists_tansh2t_teflak ul.ui-tabs-nav-en li
{ 
...
.feat_lists_tansh2t_teflak .ui-tabs-panel-en
{ 
	width: 782px;
	height: 300px;
	position: relative;
...
<div class="feat_lists_tansh2t_teflak" id="<?php echo $id_tag_string ?>">
		...
		<div class="border_fix_for_tab<?php if($language_init == 'en') echo '-en'; ?> <?php echo $current_section_border_color ?> " >
        </div>
        
      <ul class="ui-tabs-nav<?php if($language_init == 'en') echo '-en'; ?>">
       <?php
  		unset($list);
        ...
        ?>
        <div id="fragment-<?php echo ($i+1);?>" class="ui-tabs-panel<?php if($language_init == 'en') echo '-en'; ?>" style="">
