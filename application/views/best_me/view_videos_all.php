...
<div class="inner_title_wrapper">
    ...
    <h1 class="<?php echo $current_section_color; ?> float_left" style="font-size:25px;"><?php echo lang('globals_nestle_videos');?></h1>
     <?php
	...
	?>
		...
		?>
        	<?php /*?><li><a <?php echo $active_string; ?>  href="<?php echo $url ?>"><?php echo $name; ?></a></li><?php */?>
...
<a href="<?php echo $url;?>" rel="prettyPhoto" title="<?php echo $short_title;?>">         

<div class="image">
<img class="play" src="<?php echo base_url(); ?>images/videos_play.png" />
<img src="https://img.youtube.com/vi/<?php echo $image;?>/0.jpg" alt="" />
</div>
</a>
...
<div class="clear"></div>
<a href="">
<div class="desc"><div style="padding:5px 10px; white-space:normal;"><h3 class="dark_gray"><?php echo $short_title; ?></h3></div></div>
</a>
</li>
