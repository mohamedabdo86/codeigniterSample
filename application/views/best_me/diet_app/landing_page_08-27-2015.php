...
<div style="width: 720px; margin-bottom:10px;" class="float_left" >
    ...
    <div class="float_left">
        ...
        <?php
          $mobil_data=array( 'maxlength' => '10' ,'name' => 'members_mobile' ,'class'=>'large_text', 'id' => 'members_mobile','onkeypress'=>'return isNumberKey(event)');                  
    ...
    <div class="float_right">
        ...
        <input type="text" class="font_size_17" id="egyptnumber" value="+20" readonly="readonly" />
        <?php
          $phone_data=array( 'maxlength' => '9' ,'name' => 'members_phone' ,'class'=>'large_text', 'id' => 'members_phone','onkeypress'=>'return isNumberKey(event)');                  
