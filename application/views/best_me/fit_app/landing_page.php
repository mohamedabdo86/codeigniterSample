...
if($this->members->members_id)
{
	...
	/*echo "<script>console.log('PHP: Member ID = ".$this->members->members_id."');</script>";*/
	
	$data['members_login'] = TRUE;
	/*echo "<script>console.log('PHP: Login = ".$data['members_login']."');</script>";*/
...
$this->load->view("best_me/fit_app/homepage" , $data);

//Home Page Calculate Calories App
if($val_1 == "calories_calculator")
{
	$data['inner_gallery_flag'] = false;
	$this->load->view("best_me/fit_app/calories_calculator" , $data);
}
...
if($val_1 == "burn_rate")
{
	...
	$this->load->view("best_me/fit_app/burn_rate" , $data);
}
...
if($val_1 == "best_life_nestle" && !$val_2)
{
	if($check)
	{
		...
		redirect('best_me/applications/9/best_life_nestle/'.$check.'');
	}else
	{
		//first time member register
		$this->load->view("best_me/fit_app/best_life_nestle");
	}
}
...
if($val_1 == "best_life_nestle" && $val_2 && !$val_3)
{
	...
	if($check_second_step)
	{
		redirect('best_me/applications/9/best_life_welcome/'.$val_2.'');
	}else
	{
		//Second step in register
		$this->load->view("best_me/fit_app/best_life_second_step", $data);
	}
}
...
{
	$this->load->view("best_me/fit_app/best_life_new_registration", $data);
}
...
if($val_1 == "best_life_welcome" && $val_2 && !$val_3)
{
	...
	$data['nestlefit_options'] = $this->nestlefit->nestlefit_options();
	...
	$this->load->view("best_me/fit_app/best_life_welcome", $data);
}
...
if($val_1 == "best_life_welcome" && $val_2 && $val_3 == 'meals')
{
	...
	$this->load->view("best_me/fit_app/meals", $data);
}
...
if($val_1 == "best_life_welcome" && $val_2 && $val_3 == 'water')
{
	...
	$this->load->view("best_me/fit_app/best_life_water", $data);
}

// Result Page
if($val_1 == "best_life_end_day" && $val_2)
{
	$this->load->view("best_me/fit_app/best_life_end_day", $data);
}

// Edit Page
if($val_1 == "best_life_data" && $val_2)
{
	$this->load->view("best_me/fit_app/best_life_data", $val_2);
}
...
{
	$data['inner_gallery_flag'] = true;
	$this->load->view("best_me/fit_app/notification_messages" , $data);
}
...
if($val_1 == "top_ten" )
{
	...
	$this->load->view("best_me/fit_app/best_life_top_ten", $data);
}
