...
<div id="ask_exper_contanier" class="dir">
    ...
    <div id="ask_title">
        <h3 class="white_color"><img  id="ask-img" src="<?php echo base_url() . "images/nestle_fit/user-profile.png"; ?>" style="width:30px;"/><span><?php echo lang('globals_ask_the_expert'); ?></span></h3>
    </div>
