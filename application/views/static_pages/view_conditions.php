...
.container{padding:35px;height:auto;}
...
<div class="white_background_color top_radius_5 height_40">
    ...
    <h1 class="terms_conditions_color innertitle"> <?php foreach($terms_conditions_desc as $title){ echo $title['static_name'.$current_language_db_prefix];} ?></h1>
    </div> 
    </div>
