...
<noscript><link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/fileupload/jquery.fileupload-noscript.css"></noscript>
<noscript><link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/fileupload/jquery.fileupload-ui-noscript.css"></noscript>
<!-- The file upload form used as target for the file upload widget -->
<form id="fileupload" action="uploader/do_upload" method="POST" enctype="multipart/form-data">
...
<script src="<?php echo base_url(); ?>assets/js/fileupload/vendor/jquery.ui.widget.js"></script>
...
<script src="<?php echo base_url(); ?>assets/js/fileupload/main.js"></script>
<!-- The XDomainRequest Transport is included for cross-domain file deletion for IE 8 and IE 9 -->
<!--[if (gte IE 8)&(lt IE 10)]>
<script src="<?php echo base_url(); ?>assets/js/fileupload/cors/jquery.xdr-transport.js"></script>
<![endif]-->