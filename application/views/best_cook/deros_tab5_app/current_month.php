...
<style>
#ui-datepicker-div{z-index: 99 !important; width: 217px;}
body.arabic #egyptnumber{margin-left: 9px !important;}

body.english .medium_text[name=members_phone], body.english .medium_text[name=member_mobile]{text-indent: 50px !important;}
.green_color{display: block; color: green;}
.selectboxit-container[role=combobox] {width: 247px;}
.selectboxit[name=lesson_day]{width: 247px !important;}
body.english .selectboxit-list[role=listbox]{left: 0 !important; width: 247px !important;}
</style>
<?php
...
if($display)
{
	$get_lessons_imge = $this->cookingclassmodel->get_random_cooking_class_recipe_images($display[0]['cooking_classes_ID']);
	...
	$current_image = base_url()."uploads/cooking_classes/".$this->cookingclassmodel->get_image($display[0]['cooking_classes_featured_image']);;
	$current_banner = base_url()."uploads/cooking_classes/".$this->cookingclassmodel->get_image($display[0]['cooking_classes_featured_image']);;
	
	//$current_image = base_url()."uploads/recipes/".$get_lessons_imge;
}
if(!$display)
{
...
<div class="float_left" style="width:500px; height:auto;">
	<div class="first_row">
    	<img class="float_left rounded_border" width="225" src="<?php echo $current_banner; ?>" alt="<?php echo $current_title;?>" />
        <h3 class="float_left best_cook_color" style="font-size: 20px;margin: 45px 5px 0 5px; width:260px;"><?php echo $current_title;?></h3>
        <div class="clear"></div>
...
<h2 class="best_cook_background_color white_color class_recipes"><?php echo lang('globals_lesson_and_recipes'); ?></h2>
    ...
    for($i=0;$i<sizeof($display_recipes);$i++)
	{
		...
		$url = site_url($this->router->class."/delicious_recipes/". generateSeotitle($id ,$title ));
...
<a href="<?php echo site_url('best_cook/applications/2/current_class'); ?>">
<img src="<?php echo base_url()."images/bestcook/DROSTAB5".$current_language_db_prefix.".png"; ?>" width="500" height="255"  style="border-radius:10px; border:none;"/>
</a>
</div>
<?php } ?>
...
<input type="hidden" name="current_days" value="<?php echo $current_days; ?>"  />
    ...
    <div class="float_right">
        ...
        <input type="text" class="font_size_17" id="egyptnumber" value="+20" readonly="readonly" />
        <input type="text" name="members_phone" class="medium_text" onkeypress="return isNumberKeyOnly(event)" maxlength="9" />
    </div>
    <div class="clear"></div>
    <div class="global_sperator_height" style="width:100%"></div>
</div>
...
<label class="fontweight"><?php echo lang('globals_subscribe_to_lesson');?>  </label> <br/>
<div class="float_left medium_text">
    ...
    <div style="margin: 0 20px;" class="float_left">
        ...
        echo form_checkbox($data);?> <a target="_blank" href="<?php echo site_url("terms_conditions");?>" style="text-decoration:underline"><?php echo lang('globals_accept_terms'); ?></a>
