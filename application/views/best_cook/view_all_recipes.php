...
else
{
	...
	if($current_language_db_prefix == "_ar")
	{
		$title = $this->common->limit_text($all_title_ar,50);
	}
	else
	{
		$title = $this->common->limit_text($all_title,50);
	}
...
<li class="float_left">
<a href="<?php echo $url ?>">
	<img class="image" width="218" height="166" alt="<?php echo $title; ?>" src="<?php echo $image ?>" />
</a>
