...
<table width="800"  border="0" cellspacing="0" cellpadding="0" style="margin:0px auto;">
	<tr>
        ...
        <tr bgcolor="#FFFFFF" align="right">
        <td style="color:#a3a3a3;font-size:20px;font-family:Tahoma, Geneva, sans-serif;padding-top:10px;padding-bottom:10px;padding-right:40px;"> تم إشتراكك فى تطبيق رجيمك الخاص بنجاح..سوف يقوم أحد خبراء نستله بالإتصال بك   </td>
        </tr>
