...
<table width="800"  border="0" cellspacing="0" cellpadding="0" style="margin:0px auto;">
	<tr>
    	...
    	<tr bgcolor="#FFFFFF" align="left">
        	<td style="color:#202b62;font-size:32px;font-family:Tahoma, Geneva, sans-serif;padding:10px 0px;"> 
        ...
        <tr bgcolor="#FFFFFF" align="left">
        <td style="color:#a3a3a3;font-size:20px;font-family:Tahoma, Geneva, sans-serif;padding-top:10px;padding-bottom:10px;padding-right:40px;">Your application to “ Your Personal Diet” has been successfully submitted.
One of Nestle Team will contact you within the next 48hours (exclude weekend)
		</td>
        </tr>
