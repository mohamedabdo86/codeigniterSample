...
<table width="800"  border="0" cellspacing="0" cellpadding="0" style="margin:0px auto;">
	<tr>
    	...
    	<tr bgcolor="#FFFFFF" align="left">
        	<td style="color:#202b62;font-size:30px;font-family:Tahoma, Geneva, sans-serif;padding:10px 0px;"> 
            Welcome 
            </td>
        </tr>
        <tr bgcolor="#FFFFFF" align="center">
        <td style="color:#a3a3a3;font-size:18px;font-family:Tahoma, Geneva, sans-serif;padding-top:10px;padding-bottom:10px;padding-right:40px;">
            Your friend <?php echo $name; ?> invites you to join our website.<br/>
            To join our website <a href="<?php echo $url; ?>" target="_blank">click here</a>.
