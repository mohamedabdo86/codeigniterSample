...
<td>
	<input type="text" name="newsletter_Exact_Dat_Of_Birt" id="datepicker" class="large_text datepicker" readonly />
...
<td>
	<input type="tel" name="newsletter_Phone_Number" />
...
<tr>	
    <td colspan="2">
    	<input name="policy" id="policy" type="checkbox" value="1" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    	    <?php
