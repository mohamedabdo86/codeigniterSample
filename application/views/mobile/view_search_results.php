...
{
	.search_res_title, .search_res_img
	{
		text-align:center;
	}
}
...
$short_desc = $this->common->limit_text($desc, 150);
...
<div class="col-xs-12 col-md-9 col-sm-9 float search_res_title">
<h2><a href="<?php echo $url; ?>"><?php echo $title; ?></a></h2>
</div>
           <div class="col-xs-12 col-md-3 col-sm-3 float search_res_img" style="text-align:center">
             
          <a href="<?php echo $url; ?>"><img src="<?php echo $image; ?>" style="margin-bottom:10px; height:auto; width: 60%;" /></a>
                </div>

                <div class="col-xs-12 col-md-9 col-sm-9 search_res_content">
               
         <p style="margin-top:10px;text-align:justify;font-size:12px;"><?php echo $short_desc; ?></p>
         </div>
</div>
...
<?php /*?><?php echo lang('globals_type'); ?> : </strong> <?php echo lang($type); ?>
<?php echo lang('globals_section'); ?> : </strong> <?php echo lang($section); ?><?php */?>
