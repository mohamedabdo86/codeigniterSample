...
<div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                ...
                <?php /*?><p style="white-space: normal;"><?php echo $desc_long_text;?></p><?php */?>
                    ...
                    <a id="#popup_video_item_<?php echo $i; ?>" class="fancybox-media" href="#popupVideo_<?php echo $i; ?>" title="<?php echo $title; ?>" >
    ...
    <div class="row">
    	<div class="col-xs-12" style="text-align:center" data-ajax="false">
        	<div style="position:relative">
				<a href="<?php  echo site_url('mobile/best_cook/upload_recipe');?>"><img class="img-responsive" src="<?php echo base_url()."images/eb3ty_image".$current_language_db_prefix.".png";?>" width="100%" /></a>            </div>
        </div>
    </div>