		...
		<div style="background:#c8c8c8;width:100%;height:40px;position:relative;">
			...
			<ul class="col-md-12 col-xs-12 col-sm-12"> 
				...
				<li id="<?php echo $i; ?>" style="list-style:none;">
                       ...
                       <a href="#insert_message_<?php echo $i; ?>" id="single_1" data-rel="popup" onclick="message(<?php echo $i.','.$article_id; ?>)"  data-ajax="true"><p class="remove_from_favourites"><?php echo lang('mycorner_remove_favourites'); ?></p></a>
...
<script>
	...
	function message(id, article_id){
			
			
			$(".ok_button").live("click", function() {
       		 item = $(this);
			var base = "<?php echo site_url_mobile('best_cook/delete_user_favourites/'); ?>"
       		 $.post(base+'/'+article_id);
       		 item.parent().parent().fadeOut(300, function() {
				$("#"+id+"").remove();
				//$(".ui-popup-screen").hide();
