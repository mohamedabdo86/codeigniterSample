...
$this_table_name = "reason";
$this_page_name_with_varibles = "{$this_page_name}?";
$state = $_GET['state'];

//Search Handle
$search_query = $_GET['search_query'];
$search_headers_attr = "reason_title;reason_title_ar"; //Seperate with semicolumns;
...
$form_array = array
(
	array("database_name" => "reason_title_ar" , "title" => "Title (Arabic)" , "type" => "text" , "required" => "0" ,"current_value"=> $display['reason_title_ar'] ) ,
	array("database_name" => "reason_title" , "title" => "Title (English)" , "type" => "text" , "required" => "0" ,"current_value"=> $display['reason_title'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"reason_title_ar", "title" => "Title (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "reason_title_ar" ,"type"=> "text"),
		array("ID"=>"reason_title", "title" => "Title (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "reason_title" ,"type"=> "text"),
	...
	{
		$data[$i]['ID'] = $display[$i]['reason_ID'];
		$data[$i]['reason_title_ar'] = $display[$i]['reason_title_ar'];
		$data[$i]['reason_title'] = $display[$i]['reason_title'];
