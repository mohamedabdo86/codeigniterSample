<?php
$page_title = "Manage Cooking Classes Members";
$single_term = "item";
$plural_term = "items";
...
$this_table_name = "cooking_classes_members";
...
$search_headers_attr = "cooking_classes_members_ID;cooking_classes_members_name"; //Seperate with semicolumns;
...
//Table Header
	$table_header = array
	(
		array("ID"=>"cooking_classes_members_name","title" => "Member Name" , "url_sort" => $this_page_name_with_varibles , "order" => "cooking_classes_members_name", "type"=> "text" ),
		array("ID"=>"cooking_classes_members_phone","title" => "Member Phone" , "url_sort" => $this_page_name_with_varibles , "order" => "cooking_classes_members_phone", "type"=> "text" ),
		array("ID"=>"cooking_classes_members_mobile","title" => "Member Mobile" , "url_sort" => $this_page_name_with_varibles , "order" => "cooking_classes_members_mobile", "type"=> "text" ),
		array("ID"=>"cooking_classes_members_email","title" => "Member Mail" , "url_sort" => $this_page_name_with_varibles , "order" => "cooking_classes_members_email", "type"=> "text" ),
		array("ID"=>"cooking_classes_members_birthdate","title" => "Member Birthdate" , "url_sort" => $this_page_name_with_varibles , "order" => "cooking_classes_members_birthdate", "type"=> "text" ),
		array("ID"=>"cooking_classes_members_lesson","title" => "Member Class Lesson" , "url_sort" => $this_page_name_with_varibles , "order" => "cooking_classes_members_lesson", "type"=> "text" ),
	);
	...
	{
		$data[$i]['ID'] = $display[$i]['cooking_classes_members_ID'];
		$data[$i]['cooking_classes_members_name'] = $display[$i]['cooking_classes_members_name'];
		$data[$i]['cooking_classes_members_phone'] = $display[$i]['cooking_classes_members_phone'];
		$data[$i]['cooking_classes_members_mobile'] = $display[$i]['cooking_classes_members_mobile'];
		$data[$i]['cooking_classes_members_email'] = $display[$i]['cooking_classes_members_email'];
		$data[$i]['cooking_classes_members_birthdate'] = $display[$i]['cooking_classes_members_birthdate'];
		$data[$i]['cooking_classes_members_lesson'] = $display[$i]['cooking_classes_members_lesson'];
	}
