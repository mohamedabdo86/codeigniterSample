...
$pictures_columns[0] = "section_slidesshow_image";
...
$form_array = array
(
	array("database_name" => "section_tips_section_id" , "title" => "Section" , "type" => "select" , "required" => "1" ,"attached_options" => $display_section ,"current_value"=> $display['section_tips_section_id'] ) ,
	array("database_name" => "section_tips_name" , "title" => "Tips (English)" , "type" => "editor" , "required" => "1" ,"current_value"=> $display['section_tips_name'] , ) ,
	array("database_name" => "section_tips_name_ar" , "title" => "Tips (Arabic)" , "type" => "editor" , "required" => "1" ,"current_value"=> $display['section_tips_name_ar'] , ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"section_tips_name","title" => "Tips (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "section_tips_name", "type"=> "text" ,  ),
		array("ID"=>"section_tips_name_ar","title" => "Tips (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "section_tips_name_ar", "type"=> "text" ,  ),	
		array("ID"=>"section_tips_section_id", "title" => "Section" , "url_sort" => $this_page_name_with_varibles , "order" => "section_tips_section_id" ,"type"=> "select" , "attached_options" => $display_section),
...
$filter_options= array(
	...
	{
		$data[$i]['ID'] = $display[$i]['section_tips_ID'];
		$data[$i]['section_tips_name'] = $display[$i]['section_tips_name'];
		$data[$i]['section_tips_name_ar'] = $display[$i]['section_tips_name_ar'];
		$data[$i]['section_tips_section_id'] = $display[$i]['section_tips_section_id'];		
