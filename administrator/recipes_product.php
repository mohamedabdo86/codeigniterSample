...
$this_table_name = "recipes_products";
$this_page_name_with_varibles = "{$this_page_name}?";
$state = $_GET['state'];

//Search Handle
$search_query = $_GET['search_query'];
$search_headers_attr = "recipes_products_name;recipes_products_name_ar"; //Seperate with semicolumns;
...
$form_array = array
(
	array("database_name" => "recipes_products_name" , "title" => "Name (English)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['recipes_products_name'] ) ,
	array("database_name" => "recipes_products_name_ar" , "title" => "Name (Arabic)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['recipes_products_name_ar'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"recipes_products_name", "title" => "Name (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "recipes_products_name" ,"type"=> "text"),
		array("ID"=>"recipes_products_name_ar", "title" => "Name (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "recipes_products_name_ar" ,"type"=> "text"),
	...
	{
		$data[$i]['ID'] = $display[$i]['recipes_products_ID'];
		$data[$i]['recipes_products_name'] = $display[$i]['recipes_products_name'];
		$data[$i]['recipes_products_name_ar'] = $display[$i]['recipes_products_name_ar'];
