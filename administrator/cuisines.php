...
$this_table_name = "cuisines";
$this_page_name_with_varibles = "{$this_page_name}?";
$state = $_GET['state'];

//Search Handle
$search_query = $_GET['search_query'];
$search_headers_attr = "cuisines_name;cuisines_name_ar"; //Seperate with semicolumns;
...
$form_array = array
(
	array("database_name" => "cuisines_name" , "title" => "Name (English)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['cuisines_name'] ) ,
	array("database_name" => "cuisines_name_ar" , "title" => "Name (Arabic)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['cuisines_name_ar'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"cuisines_name", "title" => "Name (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "cuisines_name" ,"type"=> "text"),
		array("ID"=>"cuisines_name_ar", "title" => "Name (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "cuisines_name_ar" ,"type"=> "text"),
	...
	{
		$data[$i]['ID'] = $display[$i]['cuisines_ID'];
		$data[$i]['cuisines_name'] = $display[$i]['cuisines_name'];
		$data[$i]['cuisines_name_ar'] = $display[$i]['cuisines_name_ar'];
