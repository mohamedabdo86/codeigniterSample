<?php
$page_title = "Privacy Policy Question & Answer";
$single_term = "record";
$plural_term = "records";
...
$this_table_name = "privacy_policy";
$this_page_name_with_varibles = "{$this_page_name}?";
$state = $_GET['state'];

//Search Handle
$search_query = $_GET['search_query'];
$search_headers_attr = "privacy_policy_question_ar;privacy_policy_question"; //Seperate with semicolumns;
...
$form_array = array
(
	array("database_name" => "privacy_policy_question_ar" , "title" => "Question (Arabic)" , "type" => "text" , "required" => "0" ,"current_value"=> $display['privacy_policy_question_ar'] ) ,
	array("database_name" => "privacy_policy_answer_ar" , "title" => "Answer (Arabic)" , "type" => "editor" , "required" => "0" ,"current_value"=> $display['privacy_policy_answer_ar'] ) ,
	array("database_name" => "privacy_policy_question" , "title" => "Question (English)" , "type" => "text" , "required" => "0" ,"current_value"=> $display['privacy_policy_question'] ) ,
	array("database_name" => "privacy_policy_answer" , "title" => "Answer (English)" , "type" => "editor" , "required" => "0" ,"current_value"=> $display['privacy_policy_answer'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"privacy_policy_question_ar", "title" => "Question (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "privacy_policy_question_ar" ,"type"=> "text"),
		array("ID"=>"privacy_policy_question", "title" => "Question (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "privacy_policy_question" ,"type"=> "text"),
	...
	{
		$data[$i]['ID'] = $display[$i]['privacy_policy_ID'];
		$data[$i]['privacy_policy_question_ar'] = $display[$i]['privacy_policy_question_ar'];
		$data[$i]['privacy_policy_question'] = $display[$i]['privacy_policy_question'];
