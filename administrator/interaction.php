...
$this_table_name = "interaction";
$this_page_name_with_varibles = "{$this_page_name}?";
$state = $_GET['state'];

//Search Handle
$search_query = $_GET['search_query'];
$search_headers_attr = "interaction_type"; //Seperate with semicolumns;
...
$form_array = array
(
	array("database_name" => "interaction_title_ar" , "title" => "Title (Arabic)" , "type" => "text" , "required" => "0" ,"current_value"=> $display['interaction_title_ar'] ) ,
	array("database_name" => "interaction_title" , "title" => "Title" , "type" => "text" , "required" => "0" ,"current_value"=> $display['interaction_title'] ) ,
	array("database_name" => "interaction_type" , "title" => "Type" , "type" => "text" , "required" => "1" ,"current_value"=> $display['interaction_type'] ) ,
	array("database_name" => "interaction_points" , "title" => "Points" , "type" => "text" , "required" => "1" ,"current_value"=> $display['interaction_points'] ) ,
	array("database_name" => "interaction_gradient_class" , "title" => "Gradient class" , "type" => "text" , "required" => "0" ,"current_value"=> $display['interaction_gradient_class'] ) ,
	array("database_name" => "interaction_bg_class" , "title" => "Background class" , "type" => "text" , "required" => "0" ,"current_value"=> $display['interaction_bg_class'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"interaction_type", "title" => "Title" , "url_sort" => $this_page_name_with_varibles , "order" => "interaction_type" ,"type"=> "text"),
		array("ID"=>"interaction_points", "title" => "Points" , "url_sort" => $this_page_name_with_varibles , "order" => "interaction_points" ,"type"=> "text"),
	...
	{
		$data[$i]['ID'] = $display[$i]['interaction_ID'];
		$data[$i]['interaction_type'] = $display[$i]['interaction_type'];
		$data[$i]['interaction_points'] = $display[$i]['interaction_points'];
