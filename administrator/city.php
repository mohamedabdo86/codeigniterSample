...
$this_table_name = "city";
$this_page_name_with_varibles = "{$this_page_name}?";
$state = $_GET['state'];

//Search Handle
$search_query = $_GET['search_query'];
$search_headers_attr = "city_title;city_title_ar"; //Seperate with semicolumns;
...
$form_array = array
(
	array("database_name" => "city_title_ar" , "title" => "Title (Arabic)" , "type" => "text" , "required" => "0" ,"current_value"=> $display['city_title_ar'] ) ,
	array("database_name" => "city_title" , "title" => "Title (English)" , "type" => "text" , "required" => "0" ,"current_value"=> $display['city_title'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"city_title_ar", "title" => "Title (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "city_title_ar" ,"type"=> "text"),
		array("ID"=>"city_title", "title" => "Title (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "city_title" ,"type"=> "text"),
	...
	{
		$data[$i]['ID'] = $display[$i]['city_ID'];
		$data[$i]['city_title_ar'] = $display[$i]['city_title_ar'];
		$data[$i]['city_title'] = $display[$i]['city_title'];
