...
$this_table_name = "easy_ideas";
$this_page_name_with_varibles = "{$this_page_name}?";
$state = $_GET['state'];

//Search Handle
$search_query = $_GET['search_query'];
$search_headers_attr = "easy_ideas_title;easy_ideas_title_ar"; //Seperate with semicolumns;
...
$pictures_columns[0] = "easy_ideas_image";
...
$form_array = array
(
	array("database_name" => "easy_ideas_title" , "title" => "Title" , "type" => "text" , "required" => "1" ,"current_value"=> $display['easy_ideas_title'] ) ,
	array("database_name" => "easy_ideas_title_ar" , "title" => "Title (Arabic)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['easy_ideas_title_ar'] ) ,
	...
	array("database_name" => "easy_active" , "title" => "Active" , "type" => "select" ,"attached_options" => $display_active, "required" => "0" ,"current_value"=> $display['easy_active'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"easy_ideas_title", "title" => "Title" , "url_sort" => $this_page_name_with_varibles , "order" => "albums_name" ,"type"=> "text"),
		array("ID"=>"easy_ideas_title_ar", "title" => "Title ( Arabic )" , "url_sort" => $this_page_name_with_varibles , "order" => "albums_name" ,"type"=> "text"),
		array("ID"=>"easy_ideas_image","title" => "Image" , "url_sort" => $this_page_name_with_varibles , "order" => "", "type"=> "image" , "image_dir"=> $current_upload_directory ,"image_version" => "thumb" ),		
	...
	array("title" => "View Steps" , "url" => "manage_easy_tips_steps.php?", "pass_varible" => "forignkey")
	...
	{
		$data[$i]['ID'] = $display[$i]['easy_ideas_ID'];
		$data[$i]['easy_ideas_title'] = $display[$i]['easy_ideas_title'];
		$data[$i]['easy_ideas_title_ar'] = $display[$i]['easy_ideas_title_ar'];
		$data[$i]['easy_ideas_image'] = $display[$i]['easy_ideas_image'];
