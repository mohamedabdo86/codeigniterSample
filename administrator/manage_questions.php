...
{
	//get current answers 
	$display_answers = $db->querySelect("select quizes_answers_ID as id , quizes_answers_quizes_unique_value_ID as result , quizes_answers_title as value from quizes_answers where quizes_answers_questions_ID = ".$id." order by quizes_answers_ord");
	$mcq_current_options = "";
	for($i=0 ; $i<sizeof($display_answers) ; $i++)
	{
		$mcq_current_options.=$display_answers[$i]['value'].",".$display_answers[$i]['result'];
	...
	//get current answers 
	$display_answers_ar = $db->querySelect("select quizes_answers_ID as id , quizes_answers_quizes_unique_value_ID as result , quizes_answers_title_ar as value from quizes_answers where quizes_answers_questions_ID = ".$id." order by quizes_answers_ord");
