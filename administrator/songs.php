...
$parent_page_title = "Records Albums";
$parent_page_name = "manage_record_albums.php";
...
$current_upload_directory = $images_dir['tracks'];
//INitilize Fields with input File  , IMPORTANT for tobesaved generator

//Pictures Columns inilitize
$pictures_columns = array();
$pictures_columns[0] = "songs_src";


$files_array_search = array ($pictures_columns[0]); 
$files_array = array 
(
	$pictures_columns[0] => array("file_type" => "document" , "file_dir" => $current_upload_directory ,"allowed" => "mp3,mp4" , "file_name" => "" , "database_name" => $this_table_name ,"id_column" => "{$this_table_name}_ID" )
);
...
$form_array = array
(
	array("database_name" => "songs_name" , "title" => "Title" , "type" => "text" , "required" => "1" ,"current_value"=> $display['songs_name'] ) ,
	array("database_name" => "songs_name_ar" , "title" => "Title ( Arabic )" , "type" => "text" , "required" => "1" ,"current_value"=> $display['songs_name_ar'] ) ,
	array("database_name" => $pictures_columns[0] , "title" => "Track Source" , "type" => "file" , "required" => "1" , "message" => "MP3 files"  ,"current_value"=>"../$current_upload_directory/" , "image_only" => $display[$pictures_columns[0]]) ,
	array("database_name" => "songs_lyrics" , "title" => "Title ( Arabic )" , "type" => "editor" , "required" => "0" ,"current_value"=> $display['songs_lyrics'] ) ,
