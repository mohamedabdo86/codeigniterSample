...
$form_array = array
(	
	array("database_name" => "ads_title" , "title" => "Title (English)" , "type" => "text" , "required" => "0" ,"current_value"=> $display['ads_title'] ) ,
	array("database_name" => "ads_title_ar" , "title" => "Title (Arabic)" , "type" => "text" , "required" => "0" ,"current_value"=> $display['ads_title_ar'] ) ,
	array("database_name" => "ads_url" , "title" => "Url" , "type" => "text" , "required" => "0" ,"current_value"=> $display['ads_url'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"ads_title","title" => "Title (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "ads_title", "type"=> "text" )	,
		array("ID"=>"ads_title_ar","title" => "Title (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "ads_title_ar", "type"=> "text" )	,
		array("ID"=>"ads_url","title" => "Url" , "url_sort" => $this_page_name_with_varibles , "order" => "", "type"=> "text" )	,
		array("ID"=>"ads_thumb","title" => "Image" , "url_sort" => $this_page_name_with_varibles , "order" => "", "type"=> "image" , "image_dir"=> $current_upload_directory ,"image_version" => "src" )	,
	...
	{
		$data[$i]['ID'] = $display[$i]['ads_ID'];		 
		$data[$i]['ads_title'] = $display[$i]['ads_title'];
		$data[$i]['ads_title_ar'] = $display[$i]['ads_title_ar'];
		$data[$i]['ads_url'] = "<a href='".$display[$i]['ads_url']."' target='_blank'><img src='".youtube($display[$i]['ads_url'])."' /></a>"; 		
		$data[$i]['ads_thumb'] = $display[$i]['ads_thumb'];
