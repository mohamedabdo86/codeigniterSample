<?php
$page_title = "Manage Nestle Fit Option";
$single_term = "item";
$plural_term = "items";
...
$this_table_name = "nestle_fit_option";
...
$search_headers_attr = "nestle_fit_option_ID;nestle_fit_option_title;nestle_fit_option_title_ar;nestle_fit_option_desc;nestle_fit_option_desc_ar"; //Seperate with semicolumns;
...
//Table Header
	$table_header = array
	(
		array("ID"=>"nestle_fit_option_title","title" => "Title (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "nestle_fit_option_title", "type"=> "text" ),
		array("ID"=>"nestle_fit_option_title_ar","title" => "Title (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "nestle_fit_option_title_ar", "type"=> "text" ),
		array("ID"=>"nestle_fit_option_desc","title" => "Description (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "nestle_fit_option_desc", "type"=> "text" ),
		array("ID"=>"nestle_fit_option_desc_ar","title" => "Description (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "nestle_fit_option_desc_ar", "type"=> "text" ),
	);
	...
	{
		$data[$i]['ID'] = $display[$i]['nestle_fit_option_ID'];
		$data[$i]['nestle_fit_option_title'] = $display[$i]['nestle_fit_option_title'];
		$data[$i]['nestle_fit_option_title_ar'] = $display[$i]['nestle_fit_option_title_ar'];
		$data[$i]['nestle_fit_option_desc'] = $display[$i]['nestle_fit_option_desc'];
		$data[$i]['nestle_fit_option_desc_ar'] = $display[$i]['nestle_fit_option_desc_ar'];
	}
