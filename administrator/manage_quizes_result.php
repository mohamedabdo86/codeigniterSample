...
$form_array = array
(
	array("database_name" => "quize_result_quizes_unique_value_ID" , "title" => "quize answer number" , "type" => "text" , "required" => "1" ,"current_value"=> $display['quize_result_quizes_unique_value_ID'] ) ,
     
	array("database_name" => "quizes_result_header" , "title" => "Title (English)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['quizes_result_header'] ) , 
	array("database_name" => "quizes_result_header_ar" , "title" => "Title (Arabic)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['quizes_result_header_ar'] ) ,
	 
    array("database_name" => "quizes_result_title" , "title" => "Description (English)" , "type" => "editor" , "required" => "1" ,"current_value"=> $display['quizes_result_title'] ) , 
	array("database_name" => "quizes_result_title_ar" , "title" => "Description (Arabic)" , "type" => "editor" , "required" => "1" ,"current_value"=> $display['quizes_result_title_ar'] ) ,
	
	array("database_name" => "quize_result_quizes_ID"  , "type" => "hidden" ,"value"=> $fkey ),
...
//Pagination Handle
$total_numbers_of_rows = $db->numRows("select * from  $this_table_name  where quize_result_quizes_ID = '$fkey'  ");
...
$display = $db->querySelect("select * from  $this_table_name  where quize_result_quizes_ID = '$fkey'  {$search_query_string}  {$sort_by_query} {$paging_query} ");
...
//Table Header
	$table_header = array
	(
		array("ID"=>"quize_result_quizes_unique_value_ID", "title" => "quize answer number" , "url_sort" => $this_page_name_with_varibles , "order" => "quize_result_quizes_unique_value_ID" ,"type"=> "text"),
		array("ID"=>"quizes_result_header", "title" => "Title (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "quizes_result_header" ,"type"=> "text"),
		array("ID"=>"quizes_result_header_ar", "title" => "Title (ENGLISH)" , "url_sort" => $this_page_name_with_varibles , "order" => "quizes_result_header_ar" ,"type"=> "text"),		 
	);
	...
	{
		$data[$i]['ID'] = $display[$i]['quizes_result_ID'];
		$data[$i]['quize_result_quizes_unique_value_ID'] = $display[$i]['quize_result_quizes_unique_value_ID'];
		$data[$i]['quizes_result_header'] = $display[$i]['quizes_result_header'];
		$data[$i]['quizes_result_header_ar'] = $display[$i]['quizes_result_header_ar'];
