...
$this_table_name = "relationship";
$this_page_name_with_varibles = "{$this_page_name}?";
$state = $_GET['state'];

//Search Handle
$search_query = $_GET['search_query'];
$search_headers_attr = "relationship_title;relationship_title_ar"; //Seperate with semicolumns;
...
$form_array = array
(
	array("database_name" => "relationship_title_ar" , "title" => "Title (Arabic)" , "type" => "text" , "required" => "0" ,"current_value"=> $display['relationship_title_ar'] ) ,
	array("database_name" => "relationship_title" , "title" => "Title (English)" , "type" => "text" , "required" => "0" ,"current_value"=> $display['relationship_title'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"relationship_title_ar", "title" => "Title (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "relationship_title_ar" ,"type"=> "text"),
		array("ID"=>"relationship_title", "title" => "Title (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "relationship_title" ,"type"=> "text"),
	...
	{
		$data[$i]['ID'] = $display[$i]['relationship_ID'];
		$data[$i]['relationship_title_ar'] = $display[$i]['relationship_title_ar'];
		$data[$i]['relationship_title'] = $display[$i]['relationship_title'];
