...
$this_table_name = "dish";
$this_page_name_with_varibles = "{$this_page_name}?";
$state = $_GET['state'];

//Search Handle
$search_query = $_GET['search_query'];
$search_headers_attr = "dish_name;dish_name_ar"; //Seperate with semicolumns;
...
$form_array = array
(
	array("database_name" => "dish_name" , "title" => "Name (English)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['dish_name'] ) ,
	array("database_name" => "dish_name_ar" , "title" => "Name (Arabic)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['dish_name_ar'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"dish_name", "title" => "Name (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "dish_name" ,"type"=> "text"),
		array("ID"=>"dish_name_ar", "title" => "Name (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "dish_name_ar" ,"type"=> "text"),
	...
	{
		$data[$i]['ID'] = $display[$i]['dish_ID'];
		$data[$i]['dish_name'] = $display[$i]['dish_name'];
		$data[$i]['dish_name_ar'] = $display[$i]['dish_name_ar'];
