...
$forignkey_colm = 'products_promotions_product_id'; // column of forignkey
...
//handle Filters
$product_brand_filter = (int) $_GET['products_promotions_ID'];
...
$pictures_columns[0] = "products_promotions_banner"; 
...
(
	...
	array("database_name" => $pictures_columns[0] , "title" => "Banner(width 700px & height 150)" , "type" => "image" , "required" => "0" , "message" => "Only png,jpg,gif Images"  ,"current_value"=>"../$current_upload_directory/" , "image_only" => $display[$pictures_columns[0]]) ,
