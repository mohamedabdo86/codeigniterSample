...
$this_table_name = "respond";
$this_page_name_with_varibles = "{$this_page_name}?";
$state = $_GET['state'];

//Search Handle
$search_query = $_GET['search_query'];
$search_headers_attr = "respond_title;respond_title_ar"; //Seperate with semicolumns;
...
$form_array = array
(
	array("database_name" => "respond_title_ar" , "title" => "Title (Arabic)" , "type" => "text" , "required" => "0" ,"current_value"=> $display['respond_title_ar'] ) ,
	array("database_name" => "respond_title" , "title" => "Title (English)" , "type" => "text" , "required" => "0" ,"current_value"=> $display['respond_title'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"respond_title_ar", "title" => "Title (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "respond_title_ar" ,"type"=> "text"),
		array("ID"=>"respond_title", "title" => "Title (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "respond_title" ,"type"=> "text"),
	...
	{
		$data[$i]['ID'] = $display[$i]['respond_ID'];
		$data[$i]['respond_title_ar'] = $display[$i]['respond_title_ar'];
		$data[$i]['respond_title'] = $display[$i]['respond_title'];
