...
$form_array = array
(
	array("database_name" => "quizes_title" , "title" => "Title" , "type" => "text" , "required" => "1" ,"current_value"=> $display['quizes_title'] ) ,
	array("database_name" => "quizes_title_ar" , "title" => "Title in Arabic" , "type" => "text" , "required" => "1" ,"current_value"=> $display['quizes_title_ar'] ) ,
	...
	array("database_name" => "quizes_flag"  , "type" => "hidden" ,"value"=> 'life_coach'  ),
...
//Pagination Handle
$total_numbers_of_rows = $db->numRows("select * from  $this_table_name  where 1  and quizes_flag = 'life_coach' {$search_query_string}  ");
...
$display = $db->querySelect("select * from  $this_table_name  where 1 and quizes_flag = 'life_coach' {$search_query_string}  {$sort_by_query} {$paging_query} ");
...
//Table Header
	$table_header = array
	(
		array("ID"=>"quizes_title", "title" => "Title" , "url_sort" => $this_page_name_with_varibles , "order" => "quizes_title" ,"type"=> "text"),
		array("ID"=>"quizes_title_ar", "title" => "Title (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "quizes_title_ar" ,"type"=> "text"),
		array("ID"=>"quizes_image","title" => "Image" , "url_sort" => $this_page_name_with_varibles , "order" => "", "type"=> "image" , "image_dir"=> $current_upload_directory ,"image_version" => "thumb" ),		
