...
*/
//Pagination Handle
$total_numbers_of_rows = $db->numRows("select * from  $this_table_name where 1 and static_type = 'ask_expert' {$search_query_string} ");
...
$display = $db->querySelect("select * from $this_table_name where 1 and static_type = 'ask_expert' {$search_query_string} {$sort_by_query} {$paging_query} ");
