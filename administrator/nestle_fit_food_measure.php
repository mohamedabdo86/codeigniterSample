<?php
$page_title = "Manage Nestle Fit Food measure";
$single_term = "item";
$plural_term = "items";
...
$this_table_name = "nestle_fit_measurments";
...
$search_headers_attr = "nestle_fit_measurments_ID;nestle_fit_measurments_title;nestle_fit_measurments_title_ar"; //Seperate with semicolumns;
...
$form_array = array
(
	array("database_name" => "nestle_fit_measurments_title" , "title" => "Title (English)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['nestle_fit_measurments_title'] ) ,
	array("database_name" => "nestle_fit_measurments_title_ar" , "title" => "Title (Arabic)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['nestle_fit_measurments_title_ar'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"nestle_fit_measurments_title","title" => "Title (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "nestle_fit_measurments_title", "type"=> "text" ),
		array("ID"=>"nestle_fit_measurments_title_ar","title" => "Title (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "nestle_fit_measurments_title_ar", "type"=> "text" ),
	);
	...
	{
		$data[$i]['ID'] = $display[$i]['nestle_fit_measurments_ID'];
		$data[$i]['nestle_fit_measurments_title'] = $display[$i]['nestle_fit_measurments_title'];
		$data[$i]['nestle_fit_measurments_title_ar'] = $display[$i]['nestle_fit_measurments_title_ar'];
