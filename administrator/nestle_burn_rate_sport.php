<?php
$page_title = "Manage Burn Rate Sport";
$single_term = "item";
$plural_term = "items";
...
$this_table_name = "nestle_fit_sport";
...
$search_headers_attr = "nestle_fit_sport_ID;nestle_fit_sport_title;nestle_fit_sport_title_ar"; //Seperate with semicolumns;
...
$form_array = array
(
	array("database_name" => "nestle_fit_sport_title" , "title" => "Title (English)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['nestle_fit_sport_title'] ) ,
	array("database_name" => "nestle_fit_sport_title_ar" , "title" => "Title (Arabic)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['nestle_fit_sport_title_ar'] ) ,

	array("database_name" => "nestle_fit_sport_burn" , "title" => "Burn Rate" , "type" => "text" , "required" => "1" ,"current_value"=> $display['nestle_fit_sport_burn'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"nestle_fit_sport_title","title" => "Title (English)" , "url_sort" => $this_page_name_with_varibles , "order" => "nestle_fit_sport_title", "type"=> "text" ),
		array("ID"=>"nestle_fit_sport_title_ar","title" => "Title (Arabic)" , "url_sort" => $this_page_name_with_varibles , "order" => "nestle_fit_sport_title_ar", "type"=> "text" ),
		array("ID"=>"nestle_fit_sport_burn","title" => "Burn Rate" , "url_sort" => $this_page_name_with_varibles , "order" => "nestle_fit_sport_burn", "type"=> "text" ),
	);
	...
	{
		$data[$i]['ID'] = $display[$i]['nestle_fit_sport_ID'];
		$data[$i]['nestle_fit_sport_title'] = $display[$i]['nestle_fit_sport_title'];
		$data[$i]['nestle_fit_sport_title_ar'] = $display[$i]['nestle_fit_sport_title_ar'];
		$data[$i]['nestle_fit_sport_burn'] = $display[$i]['nestle_fit_sport_burn'];
	}
