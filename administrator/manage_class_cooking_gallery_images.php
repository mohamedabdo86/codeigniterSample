...
$parent_page_name = "manage_class_cooking_gallery.php";
...
if($forignkey == "" )
$forignkey = $_POST['cooking_classes_gallery_images_cooking_classes_gallery_ID'];
...
$this_table_name = "cooking_classes_gallery_images";
...
$pictures_columns[0] = "cooking_classes_gallery_images_image";
...
(
	...
	array("database_name" => "cooking_classes_gallery_images_cooking_classes_gallery_ID"  , "type" => "hidden" ,"value"=> $forignkey  ),
...
//Pagination Handle
$total_numbers_of_rows = $db->numRows("select * from  $this_table_name where 1 and cooking_classes_gallery_images_cooking_classes_gallery_ID = {$forignkey} {$search_query_string}");
...
$display = $db->querySelect("select * from $this_table_name where 1 and cooking_classes_gallery_images_cooking_classes_gallery_ID = {$forignkey} {$search_query_string} {$sort_by_query} {$paging_query} ");


//Table Header
	$table_header = array
	(
		array("ID"=>"cooking_classes_gallery_images_image","title" => "Image" , "url_sort" => $this_page_name_with_varibles , "order" => "", "type"=> "image" , "image_dir"=> $current_upload_directory ,"image_version" => "thumb" ),		
	);
	...
	{
		$data[$i]['ID'] = $display[$i]['cooking_classes_gallery_images_ID'];		
		$data[$i]['cooking_classes_gallery_images_image'] = $display[$i]['cooking_classes_gallery_images_image'];
