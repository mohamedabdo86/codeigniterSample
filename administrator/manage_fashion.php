...
$this_table_name = "fashion";
$this_page_name_with_varibles = "{$this_page_name}?";
$state = $_GET['state'];

//Search Handle
$search_query = $_GET['search_query'];
$search_headers_attr = "fashion_title;fashion_title_ar"; //Seperate with semicolumns;
...
$crop_settings[$pictures_columns[$current_cropsettings_index]]['thumbnail_preview_height'] = 167;
$crop_settings[$pictures_columns[$current_cropsettings_index]]['thumbnail_final_width'] = 222;
$crop_settings[$pictures_columns[$current_cropsettings_index]]['thumbnail_final_height'] = 167;
...
$form_array = array
(
	array("database_name" => "fashion_title" , "title" => "Title" , "type" => "text" , "required" => "1" ,"current_value"=> $display['fashion_title'] ) ,
	array("database_name" => "fashion_title_ar" , "title" => "Title (Arabic)" , "type" => "text" , "required" => "1" ,"current_value"=> $display['fashion_title_ar'] ) ,
	...
	array("database_name" => "fashion_desc" , "title" => "Desc" , "type" => "editor" , "required" => "0" ,"current_value"=> $display['fashion_desc'] ) ,
	array("database_name" => "fashion_desc_ar" , "title" => "Desc (Arabic)" , "type" => "editor" , "required" => "0" ,"current_value"=> $display['fashion_desc_ar'] ) ,
...
//Table Header
	$table_header = array
	(
		array("ID"=>"fashion_title", "title" => "Title" , "url_sort" => $this_page_name_with_varibles , "order" => "albums_name" ,"type"=> "text"),
		array("ID"=>"fashion_title_ar", "title" => "Title ( Arabic )" , "url_sort" => $this_page_name_with_varibles , "order" => "albums_name" ,"type"=> "text"),
		array("ID"=>"fashion_image","title" => "Image" , "url_sort" => $this_page_name_with_varibles , "order" => "", "type"=> "image" , "image_dir"=> $current_upload_directory ,"image_version" => "thumb" ),		
	...
	array("title" => "View Images" , "url" => "manage_fashion_steps.php?", "pass_varible" => "forignkey")
	...
	{
		$data[$i]['ID'] = $display[$i]['fashion_ID'];
		$data[$i]['fashion_title'] = $display[$i]['fashion_title'];
		$data[$i]['fashion_title_ar'] = $display[$i]['fashion_title_ar'];
		$data[$i]['fashion_image'] = $display[$i]['fashion_image'];
