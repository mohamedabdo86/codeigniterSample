...
$form_array = array
(
	array("database_name" => "static_name_ar" , "title" => "Title (Arabic)" , "type" => "editor" , "required" => "0" ,"current_value"=> $display['static_name_ar'] , "message" => "Always press CTRL + ALT + V when pasting from Word Document"   ) ,
	array("database_name" => "static_name" , "title" => "Title (English)" , "type" => "editor" , "required" => "0" ,"current_value"=> $display['static_name'] , "message" => "Always press CTRL + ALT + V when pasting from Word Document"   ) ,
