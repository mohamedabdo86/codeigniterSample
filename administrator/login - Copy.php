...
if($_SESSION['current_backend_user_id']!="")
...
<?php
	  ...
	  switch ($status_error)
	  {
		  case "error": $status_message = "Invalid email or password.";break;
		  case "forgoterror": $status_message = "The entered email were not found at the system	 database";break;
